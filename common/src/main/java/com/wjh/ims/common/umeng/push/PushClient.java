...
public class PushClient {
	...
	public void send(UmengNotification msg) throws RecruitException, IOException {
		...
		while ((line = rd.readLine()) != null) {
         ...
         // 推送失败 有可能是参数填写错误，有可能是网络原因，服务调用层处理异常
         if (HTTP_OK_STATUS != status){
			 logger.error("umeng send result:"+result.toString());
         	throw new RecruitException(RecruitErrorEnum.PUSH_UMENG_MESSAGE_FAIL_ERROR);
		 }
    }
