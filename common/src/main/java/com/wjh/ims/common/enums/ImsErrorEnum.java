...
public enum ImsErrorEnum {
    ...
    ImsErrorEnum(String code, String englishName, String chinaName, String description) {
        this.code = code;
     ...
     */
    public ImsErrorEnum getByCode(String code) {
        for (ImsErrorEnum e : ImsErrorEnum.values()) {
