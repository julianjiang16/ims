...
public abstract class UmengNotification {
	...
	public abstract boolean setPredefinedKeyValue(String key, Object value) throws RecruitException;
	...
	public void setProductionMode(Boolean prod) throws RecruitException {
    	setPredefinedKeyValue("production_mode", prod.toString());
    }

	///正式模式
    public void setProductionMode() throws RecruitException {
    	setProductionMode(true);
    }

    ///测试模式
    public void setTestMode() throws RecruitException {
    	setProductionMode(false);
    }

    ///发送消息描述，建议填写。
    public void setDescription(String description) throws RecruitException {
    	setPredefinedKeyValue("description", description);
    }

    ///定时发送时间，若不填写表示立即发送。格式: "YYYY-MM-DD hh:mm:ss"。
    public void setStartTime(String startTime) throws RecruitException {
    	setPredefinedKeyValue("start_time", startTime);
    }
    ///消息过期时间,格式: "YYYY-MM-DD hh:mm:ss"。
    public void setExpireTime(String expireTime) throws RecruitException {
    	setPredefinedKeyValue("expire_time", expireTime);
    }
    ///发送限速，每秒发送的最大条数。
    public void setMaxSendNum(Integer num) throws RecruitException {
